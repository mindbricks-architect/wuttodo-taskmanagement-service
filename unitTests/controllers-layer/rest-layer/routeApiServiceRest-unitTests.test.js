...
describe("CreateTaskRestController", () => {
  let createTask;
  ...
  beforeEach(() => {
    ...
    createTask = proxyquire(
      "../../../src/controllers-layer/rest-layer/main/task/create-task-api.js",
      {
        serviceCommon: {
          HexaLogTypes: {},
        ...
        apiLayer: {
          CreateTaskManager: sinon.stub(),
        },
        "../../TaskManagementServiceRestController": class {
