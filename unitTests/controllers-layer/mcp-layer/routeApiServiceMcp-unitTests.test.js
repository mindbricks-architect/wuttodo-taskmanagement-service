...
describe("CreateTaskMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/task/create-task-api.js",
      {
        apiLayer: { CreateTaskManager: ManagerStub },
        "../../TaskManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createTask");
