...
const { dbScriptDeleteTask } = require("dbLayer");

class DeleteTaskManager extends TaskManager {
  ...
  async doBusiness() {
    const task = await dbScriptDeleteTask(this);
    return task;
  }
...
module.exports = DeleteTaskManager;
