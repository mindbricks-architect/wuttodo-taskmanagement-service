...
const exposedHeaders = [
  "wuttodo-access-token",
  "wuttodo-refresh-token",
  "set-cookie",
];
if (!corsOrigin) {
  app.use(
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "wuttodo-taskManagement-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="wuttodo-taskManagement-postman-collection.json"',
  );
