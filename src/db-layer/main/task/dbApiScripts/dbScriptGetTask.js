...
// This script is called from the GetTaskManager
...
const dbScriptGetTask = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Task.findOne(options);
    ...
    console.log(err);
    throw new HttpServerError("errMsg_dbErrorWhenExecuting_dbScriptGetTask", {
...
module.exports = dbScriptGetTask;
