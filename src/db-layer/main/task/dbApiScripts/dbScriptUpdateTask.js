...
// This script is called from the UpdateTaskManager
...
const dbScriptUpdateTask = async (apiManager) => {
  ...
  try {
    ...
    let rowsCount = null;
    let dbDoc = null;
    [rowsCount, [dbDoc]] = await Task.update(dataClause, {
      where: whereClause,
      returning: true,
    });
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptUpdateTask",
      {
...
module.exports = dbScriptUpdateTask;
