...
const taskManagementPackage = grpcObject.taskManagement;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is wuttodo-taskmanagement-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(taskManagementPackage.taskManagementService.service, {
  helloMessage,
  ...sessionRouter,
});
