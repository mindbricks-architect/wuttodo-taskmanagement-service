...
_Resource Definition_ : A single todo task with a required title. Represents a minimal to-do item for a personal list.
_Task Resource Properties_
...
_API Definition_ : Add a new todo task with a required title.

_API Crud Type_ : create

_Default access route_ : _POST_ `/v1/tasks`
...
> For a detailed description of the `` api with its internal and inter-service logic please refer to the [Business API Specification Document For Create Task](businessApi/createTask).

### Update Task API

_API Definition_ : Edit (update) the title of an existing todo task.

_API Crud Type_ : update

_Default access route_ : _PATCH_ `/v1/tasks/:taskId`
...
> For a detailed description of the `` api with its internal and inter-service logic please refer to the [Business API Specification Document For Update Task](businessApi/updateTask).

### Delete Task API

_API Definition_ : Delete a todo task by its ID.

_API Crud Type_ : delete

_Default access route_ : _DELETE_ `/v1/tasks/:taskId`

#### Parameters

The deleteTask api has got 1 parameter
...
> For a detailed description of the `` api with its internal and inter-service logic please refer to the [Business API Specification Document For Delete Task](businessApi/deleteTask).

### Get Task API

_API Definition_ : Retrieve details of a single todo task by its ID.

_API Crud Type_ : get

_Default access route_ : _GET_ `/v1/tasks/:taskId`

#### Parameters

The getTask api has got 1 parameter

| Parameter | Type | Required | Population             |
| --------- | ---- | -------- | ---------------------- |
| taskId    | ID   | true     | request.params?.taskId |

To access the api you can use the **REST** controller with the path **GET /v1/tasks/:taskId**
...
> For a detailed description of the `` api with its internal and inter-service logic please refer to the [Business API Specification Document For Get Task](businessApi/getTask).

### List Tasks API

_API Definition_ : Retrieve a list of all todo tasks.

_API Crud Type_ : list

_Default access route_ : _GET_ `/v1/tasks`

The listTasks api has got no parameters.

To access the api you can use the **REST** controller with the path **GET /v1/tasks**
...
Following JSON represents the most comprehensive form of the **`tasks`** object in the respones. However, some properties may be omitted based on the object's internal logic.
...
> For a detailed description of the `` api with its internal and inter-service logic please refer to the [Business API Specification Document For List Tasks](businessApi/listTasks).
